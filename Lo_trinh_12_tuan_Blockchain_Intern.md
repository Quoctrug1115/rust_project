...
| 4 | Public-key cryptography: asymmetric encryption, digital signature là gì, vì sao blockchain cần nó | [Cloudflare – ECC blog series](https://blog.cloudflare.com/a-relatively-easy-tso-understand-primer-on-elliptic-curve-cryptography/) | Dùng crate `ed25519-dalek`: generate keypair, sign message, verify signature. |
